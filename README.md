...
### Κοινότητες Χρηστών
Το OpenDeskLab απευθύνεται σε όλους τους εργαστηριακούς χώρους, είτε πρόκειται για σχολικές εγκαταστάσεις είτε ανοιχτές κοινότητες makers, όπως hackerspaces, makerlabs, fablabs κλπ. 

### Κοινότητες Κατασκευαστών
Οι κατασκευαστές που ενδιαφέρονται να αναπτύξουν/επεκτείνουν το έργο, προτείνεται να έχουν γνώσεις πάνω στην κατασκευή επίπλων ή τον μηχανολογικό σχεδιασμό, πρόσβαση σε κάποιο ανοιχτό ή κλειστό πρόγραμμα τρισδιάστατου σχεδιασμού και γνώσεις της πλατφόρμας Sphinx (σύνταξη κειμένου σε Restructured Text).

Βεβαίως, ενθαρρύνονται όλες οι προτάσεις για περαιτέρω βελτίωση του έργου ακόμα και από απλούς χρήστες που παρατήρησαν κάποια έλλειψη ή κάποια δυσλειτουργία του OpenDeskLab, με την χρήση των issues.

## Κόστος

Όσον αφορά το κόστος, το OpenDeskLab μπορεί να παραμετροποιηθεί με πολλούς διαφορετικούς τρόπους, μεταβάλλοντας σημαντικά το τελικό κόστος του ανά μονάδα. Το πιο ακριβό κομμάτι του είναι το `Hazardous Materials Cabinet <https://opendesklab.readthedocs.org/en/latest/include/parts/hazardous_materials_cabinet.html#bill-of-materials>`_, που στοιχίζει περίπου 226 euro. Από την άλλημ το `Drawer Cabinet <https://opendesklab.readthedocs.org/en/a/include/parts/drawer_cabinet.html#bill-of-materials>`_ κοστίζει μόλις 56 euro, το `Double Cabinet <https://opendesklab.readthedocs.org/en/latest/include/parts/double_cabinet.html#bill-of-materials>`_ μόνο 57 euro και το `Single Cabinet <https://opendesklab.readthedocs.org/en/latest/include/parts/single_cabinet.html#bill-of-materials>`_ μόλις 40 euro. Τα επιπρόσθετα κομμάτια που είναι απαραίτητα για το OpenDeskLab κοστίζουν σαφώς λιγότερο, για παράδειγμα το `Short Desk Back <https://opendesklab.readthedocs.org/en/latest/include/parts/desk_back.html#id3>`_ ξεκινάει περίπου στα 39 euro και μπορεί να φτάσει τα 82 euro για την έκδοση Tall, ενώ τα `Side Panels <https://opendesklab.readthedocs.org/en/latest/include/parts/desk_side.html#id3>`_ κοστίζουν 22 ή 33 euro το ζευγάρι, για την short ή την tall έκδοση αντίστοιχα. 

Τα πιο ακριβά απαραίτητα κομμάτια του OpenDeskLab είναι τα ηλεκτρικά και πνευματικά φις του `Cable Routing <https://opendesklab.readthedocs.org/en/latest/include/parts/cable_routing.html#bill-of-materials>`_, που ξεκινούν από τα 78 euro και μπορούν να φτάσουν τα 131 euros. Το κομμάτι `Worktop <https://opendesklab.readthedocs.org/en/latest/include/parts/worktop.html#bill-of-materials>`_ από την άλλη πλευρά κοστίζει από 33 euro μέχρι περίπου 56 euro έκαστο (για διαφορετικές διαστάσεις).

Τα ανωτέρω κόστη είναι υπολογισμένα σύμφωνα με τις τιμές των πρώτων υλών, και ενδέχεται να διαφέρουν στην περίπτωση που η διαμόρφωση της κατασκευής (ή η ποσότητα των κατασκευαζόμενων γραφείων) αφήνει μεγάλο περίσσευμα πρώτης ύλης ανεκμετάλευτο (φύλλα μελαμίνης, πάγκος εργασίας, βίδες κλπ).

Για την κατασκευή των φύλλων μελαμίνης χρείαζεται πρόσβαση σε εργαλειομηχανή κατεργασίας ξύλου αριθμητικού ελέγχου. Για την συναρμολόγηση του γραφείου, ανάλογα με την διαμόρφωση του, χρειάζονται ελάχιστα εργαλεία, θεωρώντας ότι τα φύλλα είναι ήδη επεξεργασμένα και οι οπές γίνανε από την εργαλειομηχανή σε προηγούμενο στάδιο.
