...
Όσον αφορά το κόστος, το OpenDeskLab μπορεί να παραμετροποιηθεί με πολλούς διαφορετικούς τρόπους, μεταβάλλοντας σημαντικά το τελικό κόστος του ανά μονάδα. Το πιο ακριβό κομμάτι του είναι το [Hazardous Materials Cabinet](https://opendesklab.readthedocs.org/en/latest/include/parts/hazardous_materials_cabinet.html#bill-of-materials), που στοιχίζει περίπου 226 euro. Από την άλλημ το [Drawer Cabinet](https://opendesklab.readthedocs.org/en/a/include/parts/drawer_cabinet.html#bill-of-materials) κοστίζει μόλις 56 euro, το [Double Cabinet](https://opendesklab.readthedocs.org/en/latest/include/parts/double_cabinet.html#bill-of-materials) μόνο 57 euro και το [Single Cabinet](https://opendesklab.readthedocs.org/en/latest/include/parts/single_cabinet.html#bill-of-materials) μόλις 40 euro. Τα επιπρόσθετα κομμάτια που είναι απαραίτητα για το OpenDeskLab κοστίζουν σαφώς λιγότερο, για παράδειγμα το [Short Desk Back](https://opendesklab.readthedocs.org/en/latest/include/parts/desk_back.html#id3) ξεκινάει περίπου στα 39 euro και μπορεί να φτάσει τα 82 euro για την έκδοση Tall, ενώ τα [Side Panels](https://opendesklab.readthedocs.org/en/latest/include/parts/desk_side.html#id3) κοστίζουν 22 ή 33 euro το ζευγάρι, για την short ή την tall έκδοση αντίστοιχα. 

Τα πιο ακριβά απαραίτητα κομμάτια του OpenDeskLab είναι τα ηλεκτρικά και πνευματικά φις του [Cable Routing](https://opendesklab.readthedocs.org/en/latest/include/parts/cable_routing.html#bill-of-materials), που ξεκινούν από τα 78 euro και μπορούν να φτάσουν τα 131 euros. Το κομμάτι [Worktop](https://opendesklab.readthedocs.org/en/latest/include/parts/worktop.html#bill-of-materials) από την άλλη πλευρά κοστίζει από 33 euro μέχρι περίπου 56 euro έκαστο (για διαφορετικές διαστάσεις).
